  ...
  return (
    <div className='bread-show'>
      <div className='breadinfo'>
        <h2 className='show_name_bread'>{bread.name}</h2>
        <hr></hr>
        <h3 className='price-breaddetails'>{formatter.format(bread.price)}</h3>
        <p className='breadshows_p'>{bread.description}</p>
        <div>
          <img
            className='contains-bread'

...
export default function BreadDetails() {
  ...
  return (
    <div className='bread-show'>
      ...
      <img className='contains-bread' style={{ width: '175px', height: '165px' }}d src={gluten} alt=""></img>
      <img className='contains-bread' 
      style={{ width: '175px', height: '165px' }}dsrc={milk} alt=""></img>
      <img className='contains-bread' style={{ width: '175px', height: '165px' }}d src={treenuts} alt=""></img>

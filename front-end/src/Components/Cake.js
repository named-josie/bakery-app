...
export default function Cake({cake, formatter, setItem, height, width, onClick }) {
  ...
  return (
    <div className='cake-card'>
      <Link to={`/cakes/` + cake.id} key={cake.id}>
        ...
        <input type="checkbox" id="heart-checkbox" onChange={e => onClick(e.target.checked)} checked={cake.is_favorite}/>

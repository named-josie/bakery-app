...
export default function Bread({ bread, formatter, setItem, height, width, onClick}) {
    ...
    <div className='bread-card'>
      ...
      onChange={handleCheckboxChange}>
        ...
        <img className='bread-pic'
          ...
          alt=''
        />
         <input type="checkbox" id="heart-checkbox" onChange={e => onClick(e.target.checked)} checked={bread.is_favorite}/>
